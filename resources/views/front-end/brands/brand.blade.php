	...
	<div class="product-agileinfo-grids w3l">
		...
		<div class="col-md-9 product-agileinfon-grid1 w3l">
			...
			<div class="bs-example bs-example-tabs" role="tabpanel" data-example-id="togglable-tabs">
				...
				<li role="presentation" class="active"><a href="#home" id="home-tab" role="tab" data-toggle="tab" aria-controls="home" aria-expanded="true"><img src="{{ asset('/') }}front-end/images/menu.png"></a></li>
				<li role="presentation"><a href="#profile" role="tab" id="profile-tab" data-toggle="tab" aria-controls="profile"><img src="{{ asset('/') }}front-end/images/menu1.png"></a></li>
				</ul>
				<div id="myTabContent" class="tab-content">
					<div role="tabpanel" class="tab-pane fade in active" id="home" aria-labelledby="home-tab">
						<div class="product-tab">
							@foreach($frontProductBrand as $value)
							<div class="col-md-4 product-tab-grid simpleCart_shelfItem" style="margin-bottom: 30px">
								<div class="grid-arr">

									<div  class="grid-arrival">
										<figure>		
											<a href="{{ route("/front_single_product",$value->id) }}" class="new-gri">
												<div class="grid-img">
					...
					<div role="tabpanel" class="tab-pane fade" id="profile" aria-labelledby="profile-tab">
						@foreach($frontProductBrand as $value)
						<div class="product-tab1" style="margin-bottom: 30px;">
