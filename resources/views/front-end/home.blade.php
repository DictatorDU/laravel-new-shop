		...
		<div class="core-slider_viewport">
			<div class="core-slider_list">
				...
				<div class="core-slider_item">
					<img src="{{ asset($value->img_one) }}" class="img-responsive" alt="">
				</div>
				 <div class="core-slider_item">
					 <img src="{{ asset($value->img_two) }}" class="img-responsive" alt="">
				 </div>
				<div class="core-slider_item">
					  <img src="{{ asset($value->img_three) }}" class="img-responsive" alt="">
				</div>
				<div class="core-slider_item">
					  <img src="{{ asset($value->img_four) }}" class="img-responsive" alt="">
				</div>
				@endforeach
			 </div>
		</div>
	...
	<div class="new-arrivals-w3agile">
		<div class="container">
			...
			<div class="arrivals-grids">
				@foreach($arrival_products as $value)
				<div class="col-md-3 arrival-grid simpleCart_shelfItem">
					<div class="grid-arr">
						<div  class="grid-arrival">
							<figure>		
								<a href="{{ route("/front_single_product",$value->id) }}" class="new-gri" data-target="#myModal1">
									<div class="grid-img">
										<img  src="{{ $value->secondImg }}" class="img-responsive" alt="">
									</div>
									<div class="grid-img">
						...
						<div class="women">
							...
							<em class="item_price">${{ $value->product_price }}.00</em></p>
						</div>
					</div>
				</div>
				@endforeach
